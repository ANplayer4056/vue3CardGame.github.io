...
createApp({
  setup() {
    ...
    const cardlist = ref([
      ...
      { id: 2 , cardText: '♦7' , cardColor: '#ff3939' , ispair: false, sortIdx: 0},
      { id: 14 , cardText: '♦7' , cardColor: '#ff3939' , ispair: false, sortIdx: 0},
      { id: 12 , cardText: '♣7' , cardColor: '#111' , ispair: false, sortIdx: 0},
      { id: 8 , cardText: '♣7' , cardColor: '#111' , ispair: false, sortIdx: 0},
      ...
      { id: 10, cardText: '♦Q' , cardColor: '#ff3939' , ispair: false, sortIdx: 0},
      { id: 15, cardText: '♦Q' , cardColor: '#ff3939' , ispair: false, sortIdx: 0},
      { id: 6, cardText: '♣K' , cardColor: '#111' , ispair: false, sortIdx: 0},
      { id: 13, cardText: '♣K' , cardColor: '#111' , ispair: false, sortIdx: 0},
    ])
